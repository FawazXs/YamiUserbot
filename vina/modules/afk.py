...
from vina import app, CMD_HELP
from config import PREFIX, LOG_CHAT
from vina.helpers.pyrohelper import get_arg
import vina.database.afkdb as vina
from vina.helpers.pyrohelper import user_afk
from vina.modules.alive import get_readable_time
from vina.helpers.utils import get_message_type, Types
...
async def afk(client, message):
    ...
    if not arg:
        ...
        reason = arg
    await vina.set_afk(True, afk_time, reason)
...
async def afk_mentioned(_, message):
    global MENTIONED
    afk_time, reason = await vina.afk_stuff()
