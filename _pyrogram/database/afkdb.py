# Coyright (c) 2021 by @levina-lab on github
# this file originally writen by levina as veez project

from . import cli
import asyncio

collection = cli["pyrogram"]["afk"]


async def set_afk(afk_status, afk since, reason):
